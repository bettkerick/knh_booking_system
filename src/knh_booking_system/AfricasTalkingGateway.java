...
//    public JSONArray SendMessage(String recipients, String message_) throws Exception
//    {
//    
...
//	return sendMessageImpl(recipients, message_, data);
//    	//return sendMessageImpro(to_, message_, data);
//    }
//    
//   
//    public JSONArray SendMessage(String recipients, String message_, String from_, int bulkSMSMode_) throws Exception
//    {	
//    	HashMap<String, String> data = new HashMap<String, String>();
//    	data.put("username", _username);
//    	data.put("recipients", recipients);
...
//    
//
//    public JSONArray SendMessage(String recipients, String message_, String from_, int bulkSMSMode_, HashMap<String, String> options_) throws Exception
//    {
//    	HashMap<String, String> data = new HashMap<String, String>();
//    	data.put("username", _username);
//    	data.put("recipients", recipients);
...
//    
//
//    public JSONObject fetchMessages(int lastReceivedId_) throws Exception
//    {
...
//    		return jsObject.getJSONObject("SMSMessageData").getJSONObject("Messages");
//    	}
//    	
...
//
//    
//    public JSONObject fetchPremiumSubscriptions (String shortCode_, String keyword_, int lastReceivedId_) throws Exception
//    {
...
//    	if(responseCode == HTTP_CODE_OK) {
//    		JSONObject jsObject = new JSONObject(response);
//    		return jsObject.getJSONObject("responses");
//    	}
//    	
//    	throw new Exception(response.toString());
//    }
//    
//    
//    public JSONObject call(String from_, String to_) throws Exception
//    {
//    	HashMap<String, String> data = new HashMap<String, String>();
//    	data.put("username", _username);
//    	data.put("from", from_);
...
//    			return jsObject.getJSONObject("entries");
//    		throw new Exception(jsObject.getString("ErrorMessage"));
//    }
// 
//   // Call methods
//    public JSONObject getNumQueuedCalls(String recipients, String queueName) throws Exception
//    {
//    	HashMap<String, String> data = new HashMap<String, String>();
//    	data.put("username", _username);
//    	data.put("phoneNumber", recipients);
...
// 
//    
//	public JSONObject getNumQueuedCalls(String recipients) throws Exception 
//    {
//    	HashMap<String, String> data = new HashMap<String, String>();
//    	data.put("username", _username);
//    	data.put("recipients", recipients);
...
//    
//   //Airtime methods
//    public JSONObject sendAirtime(String recipients_) throws Exception 
//    {
//    	HashMap<String, String> data_ = new HashMap<String, String>();
//    	data_.put("username", _username);
...
//    	if(responseCode == HTTP_CODE_CREATED) {
//    		JSONObject jsObject = new JSONObject(response);
//    		JSONObject results = jsObject.getJSONObject("responses");
//    		if(results.length() > 0)
//    			return results;
//    		throw new Exception(jsObject.getString("errorMessage"));
//    	}
...
//    
////    
////    private JSONObject sendMessageImpro(String to_, String message_, HashMap<String, String> data_) throws Exception{
////    	String response = sendPOSTRequest(data_, SMSURLString);
////    	if (responseCode == HTTP_CODE_CREATED) {
////    		JSONObject jsObject = new JSONObject(response);
////    		JSONArray  recipients = jsObject.getJSONArray("SMSMessageData").getJSONArray("");
////    		return response;
////    	}
////    	
////    	throw new Exception(response);
...
////    private JSONObject queuedCalls(HashMap<String, String> data_) throws Exception {
...
public class AfricasTalkingGateway
{
    ...
    //Bulk messages methods
    public org.json.JSONArray sendMessage(String to_, String message_) throws Exception
    {
    ...
    public org.json.JSONArray sendMessage(String to_, String message_, String from_) throws Exception
    {	
    	HashMap<String, String> data = new HashMap<String, String>();
    	data.put("username", _username);
    	data.put("to", to_);
    ...
    public org.json.JSONArray sendMessage(String to_, String message_, String from_, int bulkSMSMode_) throws Exception
    {	
    	HashMap<String, String> data = new HashMap<String, String>();
    	data.put("username", _username);
    	data.put("to", to_);
    ...
    public org.json.JSONArray sendMessage(String to_, String message_, String from_, int bulkSMSMode_, HashMap<String, String> options_) throws Exception
    {
    	HashMap<String, String> data = new HashMap<String, String>();
    	data.put("username", _username);
    	data.put("to", to_);
    ...
    public org.json.JSONArray fetchMessages(int lastReceivedId_) throws Exception
    {
    ...
    public org.json.JSONArray fetchPremiumSubscriptions (String shortCode_, String keyword_, int lastReceivedId_) throws Exception
    {
    	if(shortCode_.length() == 0 || keyword_.length() == 0)
	    throw new Exception("Please supply short code and keyword");
    ...
    public org.json.JSONArray call(String from_, String to_) throws Exception
    {
    	HashMap<String, String> data = new HashMap<String, String>();
    	data.put("username", _username);
    	data.put("from", from_);
    ...
    //Call methods
    public org.json.JSONArray getNumQueuedCalls(String phoneNumber, String queueName) throws Exception
    {
    	HashMap<String, String> data = new HashMap<String, String>();
    	data.put("username", _username);
    ...
    public org.json.JSONArray getNumQueuedCalls(String phoneNumber) throws Exception 
    {
    	HashMap<String, String> data = new HashMap<String, String>();
    	data.put("username", _username);
    ...
    //Airtime methods
    public org.json.JSONArray sendAirtime(String recipients_) throws Exception 
    {
    	HashMap<String, String> data_ = new HashMap<String, String>();
    	data_.put("username", _username);
    	data_.put("recipients", recipients_);
    	...
    	if(responseCode == HTTP_CODE_CREATED) {
	    JSONObject jsObject = new JSONObject(response);
	    org.json.JSONArray results = jsObject.getJSONArray("responses");
	    if(results.length() > 0)
		return results;
	    throw new Exception(jsObject.getString("errorMessage"));
    	}
    ...
    public org.json.JSONArray mobilePaymentB2CRequest(String productName_,
					      List<MobilePaymentB2CRecipient> recipients_) throws Exception
    {
	    ...
	    .put("recipients", jsonRecipients);
	  	...
	  	org.json.JSONArray entries = jsonResponse.getJSONArray("entries");
    ...
    private org.json.JSONArray sendMessageImpl(String to_, String message_, HashMap<String, String> data_) throws Exception {
    	String response = sendPOSTRequest(data_, getSmsUrl());
    	if (responseCode == HTTP_CODE_CREATED) {
	    JSONObject jsObject   = new JSONObject(response);
	    org.json.JSONArray  recipients = jsObject.getJSONObject("SMSMessageData").getJSONArray("Recipients");
	    if(recipients.length() > 0) return recipients;
    ...
    //Private accessor methods
    private org.json.JSONArray queuedCalls(HashMap<String, String> data_) throws Exception {
